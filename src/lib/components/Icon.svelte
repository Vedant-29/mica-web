<script>
	// Inline SVG rather than an icon font or sprite: there are two of them, they must
	// inherit the button's text colour, and this keeps the page free of extra requests.
	...
	const PATHS = {
		...
		download: 'M8 1v8.5M4.5 6.5L8 10l3.5-3.5M2 12.5h12'
	};

	const STROKE = name === 'download';
</script>
